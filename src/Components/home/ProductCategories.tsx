    ...
    return (
        <section className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16 bg-blue-50 rounded-lg shadow-lg -mt-8 relative z-20">
            ...
            <div className="mt-12 md:mt-16 text-center">
                <Button asChild variant="outline" className="border-blue-500 bg-transparent text-blue-600 hover:bg-blue-50 hover:text-blue-700 px-6 sm:px-8 py-3 text-base sm:text-lg rounded-full transition-all duration-300 shadow-md hover:shadow-lg">
